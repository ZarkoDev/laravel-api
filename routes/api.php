...
Route::group(['middleware' => ['api.auth']], function () {
    ...
    Route::post('/task/status', [TaskController::class, 'getTaskStatus'])->name('task.status');
    Route::post('/task/response', [TaskController::class, 'getTaskResponse'])->name('task.response');
});
